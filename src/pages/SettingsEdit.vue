...
export default {
    ...
    created () {
        this.sensorSettingId = this.$route.params.id;
        sensorSettingsService.getOne(this.sensorSettingId)
            .then(response => {
                this.sensorSetting.name = response.name
                this.sensorSetting.acceptableConsecutiveFailures = response.acceptableConsecutiveFailures
                this.sensorSetting.cyclesToRefresh = response.cyclesToRefresh
                this.sensorSetting.requestTimeout = response.requestTimeout
            })
    },
    methods: {
        update() {
            sensorSettingsService.update(this.sensorSettingId, this.sensorSetting)
